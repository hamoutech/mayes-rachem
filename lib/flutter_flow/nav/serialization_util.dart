    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case StockMovementsRow:
            return StockMovementsRow(data);
          case VDailySalesRow:
            return VDailySalesRow(data);
          case VLowStockRow:
            return VLowStockRow(data);
          case VStockValueRow:
            return VStockValueRow(data);
          case VTopProductsRow:
            return VTopProductsRow(data);
          case WilayasRow:
            return WilayasRow(data);
          default:
            return null;
        }
