...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => HomePage2Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => HomePage2Widget(),
        ),
        FFRoute(
          name: HeaderComp7Widget.routeName,
          path: HeaderComp7Widget.routePath,
          builder: (context, params) => HeaderComp7Widget(),
        ),
        FFRoute(
          name: ProductCardComp4Widget.routeName,
          path: ProductCardComp4Widget.routePath,
          builder: (context, params) => ProductCardComp4Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: FooterComp6Widget.routeName,
          path: FooterComp6Widget.routePath,
          builder: (context, params) => FooterComp6Widget(),
        )
